...
import { streamIdState, sessionClientAnswerState, sessionIdState, sdpResponseState } from "@/state/d_id_stream-atoms";
...
export async function getSdpReply () {
  ...
  const sdp = await fetch(`https://api.d-id.com/talks/streams/${streamId}/sdp`, {
    method: 'POST',
    headers: {
